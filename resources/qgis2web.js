...
map.getView().fit([-10081620.690309, 1605398.067821, -10055467.427057, 1622953.408331], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">INDICE DE HUMEDAD TOPOGRAFICA DEPARTAMENTO DE SANTA ROSA</h2>';
        return titleElement;
    })(),
